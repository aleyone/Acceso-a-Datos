	...
	public void control() {
		alCreateConnection = new ActionListener() {
			public void actionPerformed(ActionEvent actionEvent) {
				...
				vista.getTextArea().setText("Se ha creado correctamente la conexión a la base de datos.\n\n"
						+ "Pulsa '?' para obtener ayuda del funcionamiento de la aplicación");
				}
		};
		...
		alCargarCSV = new ActionListener() {
			public void actionPerformed(ActionEvent actionEvent) {
				...
				FileNameExtensionFilter filter = new FileNameExtensionFilter("Ficheros válidos", "csv", "json");
		...
		alHelp = new ActionListener() {
			public void actionPerformed(ActionEvent actionEvent) {
				vista.getTextArea().setText("- MOSTRAR REGISTROS: Para ver todos los registros, pulsa 'Mostrar todos los registros'.\n\n"
						...
						+ "modifica en la línea inferior EL MISMO criterio y pulsa 'Modifica el registro'.\n\n"
						+ "- CREAR REGISTRO: Introduce datos en la línea inferior y pulsa 'Crear nuevo'.\n\n"
		...
		alCreate = new ActionListener() {
			public void actionPerformed(ActionEvent actionEvent) {
				...
				String formato = vista.getTextField_Formato().getText();
				modelo.createRegistry(collection, grupo, titulo, (int)Integer.parseInt(año_p), formato);
