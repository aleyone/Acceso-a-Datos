...
public class main {
	...
	public static void main(String[] args) {
		Libro milibro = new Libro(1, "titulo1", "autor1", "año1", "editorial1", "muchas paginas");
		...
		while (!respuesta.equals("6")) {
			...
			case "3":
				...
				String dimeAño = teclado.nextLine();
				...
				Libro newLibro = new Libro(dimeID, dimeNombre, dimeAutor, dimeAño, dimeEditorial, dimePaginas);
