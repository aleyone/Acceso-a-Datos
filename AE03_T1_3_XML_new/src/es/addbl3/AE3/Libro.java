...
class Libro {
	 ...
	 * identificamos la posición en la lista para retornarlo
	 * 
	...
	/**
	 * este método está relacionado con el anterior, ya que recoge el libro que
	 ...
	 * eliminamos la posición deseada. Posteriormente se guarda el nuevo XML sin el
	 * libro eliminado
	 * 
	...
	/**
	 * desde el identificador, ofrecemos al usuario saber qué datos del libro desea
	 * editar. Puede realizar varios cambios y éstos se guardarán cuando se finalice
	 * la edición.
	 * 
		...
		while (!eleccion.equals("F")) {
			...
			try {
				...
				case "Y":
					...
					miListado.get(puntero).setAño(br.readLine());
					break;
				case "E":
...
//		}
	...
	/**
	 * el método guarda en un fichero XML el contenido de la lista de objetos que se
	 * le pase. Es invocado desde varios métodos. Al crear un libro, actualizar o
